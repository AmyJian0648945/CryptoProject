...
uint32_t g[baseLength];
uint32_t p[modLength];
uint32_t privateExponentB[sizePrExpAB];
uint32_t modulusB[sizeModulusAB];
uint32_t modulusA[sizeModulusAB];
uint32_t privateExponentA[sizePrExpAB]
uint32_t publicExponent[1];
uint32_t x[expLengthMAX];
uint32_t y[expLengthMAX];
uint32_t gx[modLength];
uint32_t gy[modLength];
...
void init_audio(){
	...
	/* For Data Transmission */
  	g[baseLength] = {0x285ad063, 0xcb4e158b, 0x19acc462, 0x9dc78b92, 0x5b557200, 0xaf8a2b99, 0xf89bac17, 0xf31c93a9, 0x40ef5755, 0xb08b406e, 0xeb08ec9a, 0x1d0a9ca9, 0xa2a06e3e, 0xd680534c};
	p[modLength] = {0xC51CD126,0x2421F27C,0x4798CDB1,0xD725389B,0xE2482950,0x8EAFD836,0x422C011E,0x6401839E,0xB3425517,0x4B255BCB,0xA3E02AF1,0x56A98037,0xEF646E83,0x972E6D24,0xE0399449};
  	...
  	modulusB[sizeModulusAB] = {0xe8d3bb3a, 0x533b8d2e, 0x40c9648c, 0xb80ad232, 0x7482d192, 0xd05640a5, 0x039f756b, 0x807191ef, 0x8210aa05, 0xc931f23e, 0xb8237380, 0xdabd61ed, 0x5cc8fa7f, 0x46c8c72d, 0x96221b4a, 0x4df4d78c, 0x302bd427, 0xd2a2873b, 0x7417bfb6, 0xb20a3d1d, 0x9d787d06, 0xfd98d0bc, 0x18416587, 0xbf65863c, 0x2c704f9e, 0x348e3d17, 0xc0b4c2d1, 0x74b80fb2, 0x024a43ea, 0xa2ceff1d, 0x2695cb72, 0x71a563e5};
  	modulusA[sizeModulusAB] = {0xcc70b25c, 0xd644e756, 0x8336c7fe, 0xe148d14c, 0x2839d46b, 0x9bf690b4, 0x6b2073d2, 0xa181a113, 0x6ebbc420, 0x34d52f5c, 0xe0c55f6c, 0xf6aed990, 0xf1a68b1a, 0xa1b5db9f, 0x1f2a0235, 0xa11c0ba0, 0x229664b8, 0x9f0272df, 0x82998679, 0x9f7c64a2, 0x90de6e7d, 0xb47d6fff, 0xe99586da, 0xe9609f47, 0xd749a8dc, 0x642692b6, 0x47f00938, 0x8d221c03, 0xfb482658, 0x2c22945d, 0x5070919f, 0x3065b46f};
  	privateExponentA[sizePrExpAB] = { 0x7af42061, 0x7340777d, 0x7166e5fb, 0x65947cc3, 0xf7c167fe, 0xdc0afb56, 0x76c34ac5, 0x57faf55c, 0x1191fdcf, 0x7cd6e628, 0x4eca85ac, 0xabe3d6d7, 0xb46dfc65, 0x24f291c6, 0x6e60be79, 0x708ec472, 0x13e2f4a6, 0xb5109716, 0x4b5ad5c3, 0xfeefd2eb, 0xdde552bd, 0x2edf499c, 0x41ac15f2, 0xc879c0c1, 0xcaad1c4e, 0xae82c05d, 0xd3e86909, 0x0be6df0e, 0x81beeb96, 0x64783820, 0xf62ab20c, 0x58187671};
  	publicExponent[1] = {0x10001};
  	x[expLengthMAX] = {0};
  	y[expLengthMAX] = {0};
  	gx[modLength] = {0};
  	gy[modLength] = {0};

  	message[sizeModulusAB*4] = {0};
  	encryptedMessage[sizeModulusAB*4] = {0};
  	identityVerified = 0;
  	key[encryptKeyLength] = {0};
...
/*** DATA TRANSMISSION ***/
   ...
   /* Dummy copy code below. Insert your encode, encrypt, decrypt, decode functions below and comment out the copy loop */
	...
	decryptHMAC(input_but, BUFLEN*2, output_buf, key, encryptKeyLength);
