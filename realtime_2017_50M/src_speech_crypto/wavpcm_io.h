...
int  wavpcm_input_read (struct wavpcm_input *input, short buffer[BUFFERSIZE*BUFFERS]);
...
void wavpcm_output_write (struct wavpcm_output *output, short inputBuffer[BUFFERSIZE*BUFFERS], int bufferBytes);
